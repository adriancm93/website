...
```{r HFA_chart, echo=FALSE, fig.height=6, fig.width=4}
# Mixed model ----------------------------------------------------------------------
model = sample %>%
  filter(season>=2006) %>%
  lmer(formula=
...
plot %>%
  ...
  theme(
    ...
    plot.title = element_text(hjust=0.5,size=11,color='gray20',family = "Trebuchet MS"),
    plot.subtitle = element_text(hjust=0.5,size=9,color='gray20',family = "Trebuchet MS"),
    axis.title = element_text(hjust=0.5,size=9,color='gray20',family = "Trebuchet MS"),
    axis.title.y = element_blank(),
    axis.text.x =  element_text(hjust=0.5,size=8,color='gray20',family = "Trebuchet MS"),
    plot.caption = element_text(size=8,color='gray20',family = "Trebuchet MS"),
...
```{r LHFA_chart, echo=FALSE, fig.height=4, fig.width=6, message=FALSE, warning=FALSE}
lst = list()
for (y in 2006:2020){
...
last couple of seasons until reaching a negative value in 2019",
  ...
  theme(
    panel.grid.minor = element_blank(),
    plot.title = element_text(hjust=0.5,size=13,color='gray20',family = "Trebuchet MS"),
    plot.subtitle = element_text(hjust=0.5,size=11,color='gray20',family = "Trebuchet MS"),
    axis.title = element_text(hjust=0.5,size=11,color='gray20',family = "Trebuchet MS"),
    axis.text.y =  element_blank(),
    axis.text.x =  element_text(hjust=0.5,size=11,color='gray20',family = "Trebuchet MS"),
...
```{r iHFA_chart, echo=FALSE, fig.height=5, fig.width=6}
lst = list()
for (y in 2006:2020){
  data_y = sample %>% dplyr::filter(season == y)
...
```{r HFA18_chart, echo=FALSE, fig.height=6, fig.width=4}
# Mixed model ----------------------------------------------------------------------
model = sample %>%
  filter(season==2020) %>%
  lmer(formula=
